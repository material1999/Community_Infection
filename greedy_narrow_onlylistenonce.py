...
t = TicToc()
runtimes_path = "runtimes/greedy_narrow/onlylistenonce.txt"
...
for graph_num in range(1, graphs + 1):
    ...
    for c_p in connected_percent:
        for t_a in times_average:
            ...
            communities_path = ("results/communities_gridsearch/onlylistenonce/" + str(graph_num) + "_" +
            ...
            greedy_narrow_path = ("results/greedy_narrow/onlylistenonce/" + str(graph_num) + "_" +
                                str(int(c_p*100)) + "%_" + str(t_a) + "x.csv")
