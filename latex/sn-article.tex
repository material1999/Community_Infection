...
\colorbox{pink}{TODO: overlap comparison}
...
\begin{figure}[ht]
\centering
\includegraphics[width=\textwidth]{plots/plot_overlap.png}
\caption{Overlap of \textit{Full greedy} and best \textit{Narrow greedy} selections}
\label{fig_overlap}
\end{figure}
