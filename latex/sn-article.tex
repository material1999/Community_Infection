...
\botrule
\end{tabular}
\footnotetext[1]{The influence graph is not strongly connected for the Only-Listen-Once model, thus the diameter attribute is incomprehensible for this case.}
