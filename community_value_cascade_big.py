...
runtimes_path = "runtimes/community_value_big/cascade.csv"
community_value_path = "results/community_value_big/cascade.csv"
...
for graph in graphs:
    ...
    for c_p in connected_percent:
        for t_a in times_average:
            ...
            communities_path = ("results/communities_gridsearch_big/cascade/" + graph + "_" +
