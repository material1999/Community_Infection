...
times_average = [11, 11.5, 12]

t = TicToc()

runtimes_path = "runtimes/community_value_big/decreasing_soc.csv"
community_value_path = "results/community_value_big/decreasing_soc.csv"
